    ...
    <table align="center" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td align="center" colspan="2" style="color: #FFFFFF">
                <strong><span style="color: #FFFFFF">Enter User Name For More Info</span></strong>.<asp:TextBox
                    ID="txtSearch" runat="server"></asp:TextBox><asp:Button ID="btnSearch" runat="server" Text="Search" OnClick="btnSearch_Click" /></td>
        </tr>
        <tr>
            <td align="center" colspan="2">
