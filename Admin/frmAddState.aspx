...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%">
        <tr>
            <td colspan="2" style="font-weight: bold; font-size: 12pt; color: #FFFFFF;" 
                align="center">
                Add State</td>
        </tr>
        <tr>
            <td colspan="2" style="font-weight: bold; font-size: x-large; color: #FFFFFF; height: 41px; background-color: #00FFFF;" 
                align="center">
                <span style="color: #000000">GOVERNMENT GIRL&#39;S POLYTECHNIC MEZA<br />
                LOGIN PAGE</span></td>
        </tr>
        <tr>
